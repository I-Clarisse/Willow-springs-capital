<nav class="bg-black bg-opacity-40 backdrop-blur-lg text-white py-4">
    <div class="container mx-auto flex items-center">
        <div class="flex items-center mr-8">
            <img src="{{ asset('images/logo_transparent_background.png') }}" alt="Logo" class="h-16 mr-4"> <!-- Increased height -->
        ...
        <div class="flex-grow flex justify-center space-x-8">
            ...
            <a href="/contact" class="hover:text-gray-300 active:underline me-4 md:me-6">Contact Us</a>
        </div>
    </div>
</nav>

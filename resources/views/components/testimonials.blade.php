        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-100 rounded-lg shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold">Clearwater, FL - Business Owner</h3>
            ...
            <div class="bg-gray-100 rounded-lg shadow-md p-6">
                <div class="flex items-center mb-4">
                    <!-- <div class="w-12 h-12 bg-gray-300 rounded-full mr-4"></div> -->
                    <div>
                        <h3 class="text-lg font-semibold">Fort Lauderdale, FL - Real Estate Investor</h3>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                            </svg>
                ...
                <p class="text-gray-700">Working with Willow Springs Capital has been a game-changer for my investment portfolio. Their deep knowledge of the market, combined with their ethical approach, gave me confidence that my investments were not only profitable but also making a positive impact on the community. Their passion for growth and innovation is clear in every project they undertake.</p>
            </div>
        </div>
    </div>
</div>